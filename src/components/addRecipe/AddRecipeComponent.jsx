...
const mapStateToProps = state => {
    return {
        ...
        isRecipedAdded: state.addReducer.isRecipedAdded
    }
};
        ...
        return (
            <div className="add-recipe">
                ...
                <div className="add-recipe__buttons">
                    ...
                    <Link className="link" to={Object.keys(this.props.currentRecipeObj).length !== 0 ? `/show-recipe/${this.props.currentRecipeObj._id}`: '/'}>
                    <Button variant="contained" className="add-recipe__buttons__cancel-btn" onClick={this.props.openAddRecipe}>Отмена</Button></Link>
                </div>
            </div>
        )
    }
